                ...
                <div className="form">
                    ...
                    <Grid container spacing={4}>
                        <Grid item xs={12} md={6}>
                            ...
                            <div className="d-flex">
                            <RadioGroup aria-label="medicare_flag" name="medicare_flag" value={this.state.medicare_flag} onChange={this.onChangeMedicareFlag} row>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <div className="d-flex">
                                <RadioGroup aria-label="work_flag" name="work_flag" value={this.state.work_flag} onChange={this.onChangeWorkFlag} row>
                                    <FormControlLabel value="-2" control={<Radio />} label="None" />
                                    <FormControlLabel value="-1" control={<Radio />} label="TBD" />
                                    <FormControlLabel value="1" control={<Radio />} label="YES" />
                                    <FormControlLabel value="0" control={<Radio />} label="No" />
                    ...
                    <Grid container spacing={4}>
                        <Grid item xs={12}>
                            ...
                            <div className="d-flex">
                                <RadioGroup aria-label="medicaid_flag" name="medicaid_flag" value={this.state.medicaid_flag} onChange={this.onChangeMedicaidFlag} row>
                                    <FormControlLabel value="-2" control={<Radio />} label="None" />
                                    <FormControlLabel value="-1" control={<Radio />} label="TBD" />
                                    <FormControlLabel value="1" control={<Radio />} label="YES" />
                                    <FormControlLabel value="0" control={<Radio />} label="No" />
